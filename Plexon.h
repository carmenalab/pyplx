...
//
extern "C" int       PL_InitClient(int type, HWND hWndList);
...
//                  the client with the server.
//
extern "C" int       PL_InitClientEx2(int type, HWND hWndMain);
...
//      Initializes PlexClient.dll for a client. Opens MMF's and registers 
//                  the client with the server.
extern "C" int       PL_InitClientEx3(int type, HWND hWndList, HWND hWndMain);
...
// Effect: 
//      none
extern "C" int       PL_IsLongWaveMode();
...
extern "C" void      PL_GetTimeStampArrays(int* pnmax, short* type, short* ch,
                                              short* cl, int* ts);
...
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetTimeStampStructures(int* pnmax, 
                                                        PL_Event* events);
...
//      Copies the timestamp structures that the server transferred to MMF since
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetTimeStampStructuresEx(int* pnmax, 
                                                    PL_Event* events,
                                                    int* pollhigh,
                                                    int* polllow);
...
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetWaveFormStructures(int* pnmax, 
                                                        PL_Wave* waves);
...
//      Copies the waveform structures that the server transferred to MMF since
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetWaveFormStructuresEx(int* pnmax, 
                                        PL_Wave* waves, 
                                        int* serverdropped,
                                        int* mmfdropped);
...
//      Copies the waveform structures that the server transferred to MMF since
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetLongWaveFormStructures(int* pnmax, 
                                        PL_WaveLong* waves, 
                                        int* serverdropped,
                                        int* mmfdropped);
...
//      Copies the waveform structures that the server transferred to MMF since
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetWaveFormStructuresEx2(int* pnmax, PL_Wave* waves,
                                                  int* serverdropped, 
                                                  int* mmfdropped,
                                                  int* pollhigh,
                                                  int* polllow);
...
//      Copies the waveform structures that the server transferred to MMF since
//          any of the PL_GetTimeStamp* or PL_GetWave* was called last time
extern "C" void      PL_GetLongWaveFormStructuresEx2(int* pnmax, PL_WaveLong* waves,
                                                  int* serverdropped, 
                                                  int* mmfdropped,
                                                  int* pollhigh,
                                                  int* polllow);
...
extern "C" void		 PL_SendUserEvent(int channel);




// "get" commands
extern "C" void      PL_GetOUTInfo(int* out1, int* out2);
extern "C" void      PL_GetSlowInfo(int* freq, int* channels, int* gains);
extern "C" void      PL_GetSlowInfo64(int* freq, int* channels, int* gains);
extern "C" void      PL_GetNumNIDAQCards(int* numcards);
extern "C" void      PL_GetSlowInfo256(int* freqs, int* channels, int* gains);
extern "C" void      PL_GetNIDAQCardSlow4(int* IsSlow);
extern "C" int       PL_GetTIMClockFreq(void);
extern "C" int       PL_GetNIDAQBandwidth(void);
extern "C" int       PL_GetActiveChannel();
extern "C" int       PL_IsElClientRunning();
extern "C" int       PL_IsSortClientRunning();
extern "C" int       PL_IsNIDAQEnabled();
extern "C" int       PL_IsDSPProgramLoaded();
extern "C" int       PL_GetTimeStampTick();
extern "C" void      PL_GetGlobalPars(int* numch, int* npw, int* npre, int* gainmult);
extern "C" void      PL_GetGlobalParsEx(int* numch, int* npw, int* npre, int* gainmult, int* maxwflength);
extern "C" void      PL_GetChannelInfo(int* nsig, int* ndsp, int* nout);
extern "C" void      PL_GetSIG(int* sig);
extern "C" void      PL_GetFilter(int* filter);
extern "C" void      PL_GetGain(int* gain);
extern "C" void      PL_GetMethod(int* method);
extern "C" void      PL_GetThreshold(int* thr);
extern "C" void      PL_GetNumUnits(int* numunits);
extern "C" void      PL_GetTemplate(int ch, int unit, int* t);
extern "C" void      PL_GetNPointsSort(int* npts);
extern "C" int       PL_SWHStatus();      // 1 if SWH board is present, otherwise 0
extern "C" int       PL_GetPollingInterval();
// this now returns the number of channels per NIDAQ card, not the total number of NIDAQ chans
extern "C" int       PL_GetNIDAQNumChannels();
extern "C" void      PL_EnableExtLevelStartStop(int enable);
extern "C" int       PL_IsNidaqServer();

extern "C" void      PL_GetName(int ch1x, char* name);
extern "C" void      PL_GetEventName(int ch1x, char* name);
extern "C" void      PL_SetSlowChanName(int ch0x, char* name);
extern "C" void      PL_GetSlowChanName(int ch0x, char* name);

// not implemented in the verison 09.98
extern "C" void      PL_GetValidPCA(int* num);
extern "C" void      PL_GetTemplateFit(int ch, int* fit);
extern "C" void      PL_GetBoxes(int ch, int* b);
extern "C" void      PL_GetPC(int ch, int unit, float* pc);
extern "C" void      PL_GetMinMax(int ch,  float* mm);
extern "C" void      PL_GetGlobalWFRate(int* t);
extern "C" void      PL_GetWFRate(int* t);
